...
*/
  class WPGHelper {
    ...
    public static function yesNoRadioList($name, $selected, $atrr = '', $yes = 'Да', $no = 'Нет') {
      $out = '<input type="radio" name="'.WPGTools::esc($name).'" value="1"';
      if ($selected) {
        $out .= ' checked="checked"';
      }
      $out .= '>&nbsp;'.$yes;
      $out .= '&nbsp;&nbsp;<input type="radio" name="'.WPGTools::esc($name).'" value="0"';
      if (!$selected) {
        $out .= ' checked="checked"';
      }
      $out .= '>&nbsp;'.$no;
